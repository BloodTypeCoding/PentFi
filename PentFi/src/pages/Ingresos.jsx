...
export default function Ingresos() {
  ...
  useEffect(() => {
    fetch("/Backend/Ingresos/ingresos.json")
      .then((r) => r.json())
      .then((data) => {
  ...
  const grouped = groupByMonth(ingresos);

  return (
    <AppLayout activePage="ingresos">
      <div className="px-4 mt-4 max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-center">Ingresos</h1>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 text-base-content/50">
            ...
            <p className="text-sm mt-1">Usá el botón + para agregar el primero</p>
          </div>
        ) : (
                    ...
                    {items.map((item) => (
                      ...
                      >
                        ...
                        <span className="font-semibold tabular-nums text-sm flex items-center gap-2">
                          ...
                          <button
                            onClick={() => navigate(`/factura/ingreso-${item._fileIdx}`)}
